...
int main()
{
    ...
    cout << "\nHello user, what is your name? " << endl;
    cin >> name;
...
*/
    ...
    print_with_delay(
        ...
        "You have been hand-picked by two different teams to take over an empty seat halfway through the season, a chance any rookie would jump at!"
        "Do you drive for Williams or Visa Cash App Redbull?");
